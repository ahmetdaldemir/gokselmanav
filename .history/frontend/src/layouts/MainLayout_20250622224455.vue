        ...
        <div class="navbar-flex">
          ...
          <div class="d-none d-md-flex navbar-center w-100">
            ...
            <div class="navbar-right">
              <v-btn icon variant="text" @click="openSocialMedia('facebook')">
                <v-icon>mdi-facebook</v-icon>
              </v-btn>
              <v-btn icon variant="text" @click="openSocialMedia('twitter')">
                <v-icon>mdi-twitter</v-icon>
              </v-btn>
              <v-btn icon variant="text" @click="openSocialMedia('instagram')">
